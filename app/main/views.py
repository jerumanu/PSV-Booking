...
def new_booking():
    ...
    if form.validate_on_submit():
        ...
        ID_numper = forms.ID_numper.data
        payment = form.payment.data

        
        new_booking = Book(start_date_time= start_date_time,end_date_time= end_date_time,mobile = mobile,ID_numper = ID_numper, payment = payment,user_id=current_user.id)
